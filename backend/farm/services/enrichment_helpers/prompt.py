...
def build_prompt(
    *,
    ...
    target_fields = [field for field in target_fields if field != 'seed_rate_transplant_value']
    ...
    return (
        ...
        "distance_within_row_cm, row_spacing_cm, sowing_depth_cm, seed_rate_direct_value, allowed_sowing_methods, thousand_kernel_weight_g, nutrient_demand. "
        ...
        "HARD RULE FOR NUMERIC FIELDS: For growth_duration_days, harvest_duration_days, propagation_duration_days, distance_within_row_cm, row_spacing_cm, sowing_depth_cm, seed_rate_direct_value, thousand_kernel_weight_g, expected_yield, suggested_fields.<field>.value MUST always be a single JSON number (never a string). "
        ...
        "seed_rate_direct_value must always be a single float in its selected unit. "
