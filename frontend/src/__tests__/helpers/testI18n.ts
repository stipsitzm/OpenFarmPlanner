export const i18nMap: Record<string, string> = {
  ...
  'plantingPlans:tooltips.missingGrowthDuration': 'Nicht berechenbar, da für diese Kultur kein Wachstumszeitraum hinterlegt ist.',
  'plantingPlans:tooltips.missingHarvestDuration': 'Nicht berechenbar, da für diese Kultur kein Erntezeitraum hinterlegt ist.',
  'plantingPlans:tooltips.missingGrowthAndHarvestDuration': 'Nicht berechenbar, da für diese Kultur weder Wachstumszeitraum noch Erntezeitraum hinterlegt sind.',
